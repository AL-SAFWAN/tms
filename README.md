...
- [Ticket Management System (TMS)](#ticket-management-system-tms)
  - [Applications Infrastructure and Services Status](#applications-infrastructure-and-services-status)
  - [Background Information](#background-information)
  - [Users for TMS Application](#users-for-tms-application)
  - [Role-Role Interactions](#role-role-interactions)
  ...
  - [Local Development](#local-development)
    - [Architecture and Container Interaction of TMS Application Development Environment](#architecture-and-container-interaction-of-tms-application-development-environment)
    - [Running FastAPI Tests](#running-fastapi-tests)
    - [Running Vite Tests](#running-vite-tests)
- [Overview](#overview)
  - [Overview of TMS Monorepo](#overview-of-tms-monorepo)
- [Coding Conventions and Tooling](#coding-conventions-and-tooling)
  - [Backend](#backend-1)
  - [Frontend](#frontend-1)
- [Authentication & Authorization - My Approach](#authentication--authorization---my-approach)
- [Validation Backend to Frontend - My Approach](#validation-backend-to-frontend---my-approach)
- [Notifications and Confirmations - Enhancing UX in My Application](#notifications-and-confirmations---enhancing-ux-in-my-application)
- [Entity Relationships and Application Context](#entity-relationships-and-application-context)
- [Backend Architecture Overview](#backend-architecture-overview)
  ...
  - [Clean Architecture Benefits in TMS](#clean-architecture-benefits-in-tms)
  - [Flow](#flow)
  - [Other Programming Concepts Implemented](#other-programming-concepts-implemented)
- [Folder Structure for Clean Architecture in TMS Backend](#folder-structure-for-clean-architecture-in-tms-backend)
